...
def set_forms(root, data):
    forms_frame = tk.LabelFrame(root, text='forms')
    ...
    send_btn = tk.Button(forms_frame, text='send', command=lambda: send(
        forms_frame,
    ...
    forms_frame.place(x=10, y=0, width=pad_x*3, height=start_y+pad_y*n_y)
    n_y+=1
